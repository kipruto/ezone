...
(function ($) {
  ...
  function displayCart() {
    ...
    for (var i in cartArray) {
      output += "<li class='single-product-cart'>" + "<div class='cart-img'>" + "<a>" + "<img src='" + cartArray[i].image + "'>" + "</a>" + "</div>" + "<div class='cart-title'>" + "<h5>" + "<a>" + cartArray[i].name + "</a>" + "</h5>" + "<span>" + "<p>Price</p>" + "<p>" + cartArray[i].price + "</p>" + "</span>" + "<div class='cart-controls'>" + "<button class='minus-item' data-pid=" + cartArray[i].pid + ">-</button>" + "<input type='text' class='item-count' data-pid='" + cartArray[i].pid + "' value='" + cartArray[i].count + "'>" + "<button class='plus-item' data-pid=" + cartArray[i].pid + ">+</button>" + "</div>" + "</div>" + "<div>" + "<p class='cart__total'><strong>SubTotal</strong></p>" + "<td>" + cartArray[i].total + "</td>" + "</div>" + "<div class='cart-delete'>" + "<button class='remove-item' type='submit'  data-pid=" + cartArray[i].pid + "><i class='ti-trash'></i></button>" + "</div>" + "</li>";
      output2 += "<tr id='calctable'>" + "<td>" + "<div class='media'>" + "<div class='d-flex'>" + "<img src='" + cartArray[i].image + "' >" + "</div>" + "<div class=' media-body'>" + " <p>" + cartArray[i].name + "</p>" + " </div>" + "</div>" + " </td>" + "<td>" + "<h5 id='itemprice'>" + cartArray[i].price + " </h5>" + "</td>" + " <td>" + "<div class='product_count'>" + "<button class='minus-item' data-pid=" + cartArray[i].pid + ">-</button>" + "<input type='text' class='item-count' data-pid='" + cartArray[i].pid + "' value='" + cartArray[i].count + "'>" + "<button class='plus-item' data-pid=" + cartArray[i].pid + ">+</button>" + "</div>" + "</td>" + " <td>" + " <h5 id='subtotaldiv'>" + cartArray[i].total + "</h5>" + " </td>" + " <td class='holdbtn'>" + " <button type='submit' class='shoping__cart__item__remove' data-pid=" + cartArray[i].pid + ">" + "<i class='pe-7s-close'>" + "</i>" + "</button>" + " </td>" + " </tr>";
      output3 += "<tr class='cart_item'>" + "<td class='product-name'>" + cartArray[i].name + " x " + "<strong class='product-quantity'>" + cartArray[i].count + "</strong>" + "</td>" + " <td class='product-total'>" + "<span class='amount'>" + cartArray[i].total + "</span>" + "</td>" + "</tr>";
    }

    if (cartArray.length === 0) {
      output += "<li class='single-product-cart'>" + "<div class='cart-title'>" + "<h5>" + "<a> Your Cart is Empty </a>" + "</h5>";
      "<span>" + "</span>";
      "</div>";
      "</li>";
      output2 += "<div>" + "<div class='empty__cart row'>" + "<div><i class='fa fa-calendar-o'></i></div>" + "<p>Your cart is empty</p>" + "</div>" + "<a class='float-left mb-3 btn_7' href='shopgrid.php'>GO TO SHOP</a>";
      +"</div>";
    ...
    if (cartArray.length > 0) {
      output += "<li class='cart-btn-wrapper' >" + "<div>" + "<strong>Total: Ksh </strong>" + "<p class='handicraft__total'></p>" + "<strong>/=</strong>" + "</div>" + "<span>" + "<a class='cart-btn btn-hover' href='cart.php'>view cart</a>" + "<a class='cart-btn btn-hover' href='checkout.php'>checkout</a>" + "</span>" + "</li>";
    }
  ...
  var proQty = $('#passwordlogin');

  if (togglepwd) {
    togglepwd.on('click', function () {
      // toggle the type attribute
      var type = proQty.attr('type') === 'password' ? 'text' : 'password';
      proQty.attr('type', type); // toggle the eye slash icon
  ...
  var prdbtns = document.querySelectorAll('[data-product-target]');
  var prdivs = document.querySelectorAll('[data-product-content]');
  prdbtns.forEach(function (prdbtn) {
    prdbtn.addEventListener('click', function () {
      var target = document.querySelector(prdbtn.dataset.productTarget);
      prdbtns.forEach(function (prdbtn) {
        prdbtn.classList.remove('active');
      });
      prdivs.forEach(function (prdiv) {
  ...
  var categorybtns = document.querySelectorAll('[data-tab-target]');
  var shopdivs = document.querySelectorAll('[data-shop-content]');
  categorybtns.forEach(function (categorybtn) {
    categorybtn.addEventListener('click', function () {
      var target = document.querySelector(categorybtn.dataset.tabTarget);
      categorybtns.forEach(function (categorybtn) {
        categorybtn.classList.remove('active');
      });
      shopdivs.forEach(function (shopdiv) {
